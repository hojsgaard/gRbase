...
<<>>=
nextCellSlice(c(1,3,1), slice_set=2, dim=c( 2, 3, 2 ))
nextCellSlice(c(2,3,1), slice_set=2, dim=c( 2, 3, 2 ))
@ %def 
...
<<>>=
slice2entry(slice_cell=3, slice_set=2, dim=c( 2, 3, 2 ))
@ %def

To verify that we indeed get the right cells:

<<>>=
r <- slice2entry(slice_cell=3, slice_set=2, dim=c( 2, 3, 2 ))
