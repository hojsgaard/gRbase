...
next_cell_slice_ <- function(cell, dim, slice_set) {
    .Call('_gRbase_next_cell_slice_', PACKAGE = 'gRbase', cell, dim, slice_set)
}

#' @rdname array-cell
slice2entry_ <- function(slice_cell, slice_set, dim) {
    .Call('_gRbase_slice2entry_', PACKAGE = 'gRbase', slice_cell, slice_set, dim)
}

#' @rdname array-cell
get_cell_number_ <- function(cell, dim, perm) {
    .Call('_gRbase_get_cell_number_', PACKAGE = 'gRbase', cell, dim, perm)
}
